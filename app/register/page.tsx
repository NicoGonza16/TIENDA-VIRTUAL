        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">
              Join NexStore for exclusive deals and faster checkout
            </p>
          </div>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-2">
                  ...
                  <Label htmlFor="agreeTerms" className="text-sm font-normal cursor-pointer leading-tight">
                    I agree to the{' '}
                    <Link href="/contact" className="text-primary hover:underline">Terms of Service</Link>
                    {' '}and{' '}
                    <Link href="/contact" className="text-primary hover:underline">Privacy Policy</Link>
                  </Label>
                </div>
                <div className="flex items-start gap-2">
                  <input
